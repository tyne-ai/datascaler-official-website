...
const translations = {
  zh: {
    title: "预约 DataScaler 演示",
    description: "告诉我们你关注的品牌和问题，团队会联系你安排时间。",
    nameLabel: "姓名 *",
    ...
    successDescription: "团队会尽快与你联系，确认演示时间和具体需求。",
    close: "关闭",
    errors: {
      name: "请输入姓名",
      company: "请输入公司名称",
  ...
  en: {
    title: "Book a DataScaler walkthrough",
    description: "Tell us what you’re trying to learn, and we’ll tailor the conversation to your team.",
    nameLabel: "Name *",
    ...
    successDescription: "Our team will follow up to find a time and learn more about your use case.",
    close: "Close",
    errors: {
