...
const STATIC_ROUTES: StaticRoute[] = [
  ...
  { path: '/brand-monitoring', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/en/brand-monitoring', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/social-listening', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/en/social-listening', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/playground', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/en/playground', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/sample/bambu-lab', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/en/sample/bambu-lab', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/pricing', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/en/pricing', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/mcp', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/en/mcp', changeFrequency: 'monthly', priority: 0.9 },
